...
No pending v1 baseline work. Validate the frozen retrieval and generation baselines before integration; behavior changes require a new semantic version.
